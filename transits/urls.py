...
urlpatterns = [
    ...
    path('api/location/reverse', views.api_location_reverse, name='api_location_reverse'),
    path('api/location/forward', views.api_location_forward, name='api_location_forward'),
    path('api/location/from-ip', views.api_location_from_ip, name='api_location_from_ip'),
